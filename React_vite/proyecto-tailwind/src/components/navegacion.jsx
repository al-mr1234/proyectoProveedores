...
const Navegacion = ()=>{
  return(
    <nav className="bg-red-400 p-4 shadow-md w-full">
    ...
    <Link to="/usuarios" className="text-white hover:text-blue-200 text-lg transition duration-300">Proveedores</Link>
